<template>
  <div class="bg-gray-900">
      ...
      <Dialog class="lg:hidden" @close="mobileMenuOpen = false" :open="mobileMenuOpen">
        ...
        <DialogPanel class="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
          <div class="flex items-center justify-between">
            <a href="#" class="-m-1.5 p-1.5">
              <span class="sr-only">O3Zone</span>
    ...
    <div class="relative isolate pt-14">
      ...
      <div class="py-24 sm:py-32 md:py-18 lg:pb-20">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <img src="../assets/pemf_ad.png" alt="App screenshot" width="2432" height="1442" class="mt-4 rounded-md pt-10 sm:mt-24 lg:mt-4" />
        </div>
      </div>
